...
/**
 * Template pattern used for creating two or more methods inside strategy
 * pattern using bury algorithm implementation.
 * 
 * @author amiyam
 *
 */
public abstract class MetadataStrategyTemplate implements MetadataStrategyBase {
	...
	protected abstract TableEntity fillComponentSchema(Map metadataOperation)

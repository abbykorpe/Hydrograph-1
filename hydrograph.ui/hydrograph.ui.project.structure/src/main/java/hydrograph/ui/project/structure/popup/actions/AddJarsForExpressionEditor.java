package hydrograph.ui.project.structure.popup.actions;
...
public class AddJarsForExpressionEditor implements IObjectActionDelegate {
	 ...
	 */
	public AddJarsForExpressionEditor() {
		super();
	}

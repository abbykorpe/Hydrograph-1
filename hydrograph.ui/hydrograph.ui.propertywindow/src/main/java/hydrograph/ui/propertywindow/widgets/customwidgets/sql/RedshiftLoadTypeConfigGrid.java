...
public class RedshiftLoadTypeConfigGrid extends Dialog {
	 ...
	 */
	public RedshiftLoadTypeConfigGrid(Shell parentShell, PropertyDialogButtonBar propertyDialogButtonBar,
	...
	public Control createDialogArea(Composite parent) {
		...
		GridData gd_updateKeys2 = new GridData(SWT.LEFT, SWT.CENTER, true, false, 10, 1);
		gd_updateKeys2.widthHint = 312;
		updateKeys2.setLayoutData(gd_updateKeys2);
		
		btnUpdate2  = new Button(composite, SWT.NONE);
		GridData gd_btnUpdate2 = new GridData(SWT.LEFT, SWT.CENTER, false, false, 1, 1);
		gd_btnUpdate2.widthHint = 126;

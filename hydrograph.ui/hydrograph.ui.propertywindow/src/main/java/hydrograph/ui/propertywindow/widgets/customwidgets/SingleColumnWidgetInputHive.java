...
import hydrograph.ui.propertywindow.widgets.dialogs.FieldDialogHivePartition;
...
public class SingleColumnWidgetInputHive extends AbstractWidget {
	...
	public SingleColumnWidgetInputHive(ComponentConfigrationProperty componentConfigProp,
	...
	public void attachToPropertySubGroup(AbstractELTContainerWidget container) {
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				FieldDialogHivePartition fieldDialog = new FieldDialogHivePartition(new Shell(), propertyDialogButtonBar,property);

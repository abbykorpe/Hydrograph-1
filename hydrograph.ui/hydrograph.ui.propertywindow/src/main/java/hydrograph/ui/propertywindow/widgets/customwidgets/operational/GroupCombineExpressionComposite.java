 ...
 *
 */
public class GroupCombineExpressionComposite extends AbstractExpressionComposite {
	...
	public GroupCombineExpressionComposite(Composite parent, int style, final MappingSheetRow mappingSheetRow,
		...
		gd_selectColumnComposite.heightHint = 316;
		...
		expressionbutton.setLayoutData(gd_button);
		expressionbutton.setText("...");
		expressionbutton.setToolTipText(Messages.EXPRESSION_COMPOSITE_BROWSE_BUTTON_TOOL_TIP);
		expressionbutton.addSelectionListener(new SelectionAdapter() {
				@Override
				public void widgetSelected(SelectionEvent e) {
					createExpressionEditorData();
					
					LaunchExpressionEditor launchExpressionEditor1 = new LaunchExpressionEditor();
					launchExpressionEditor1.launchExpressionEditor(mappingSheetRow.getExpressionEditorData(),
							getInputSchema(component), mappingSheetRow.getOperationID());
					expression_text_1.setText(mappingSheetRow.getExpressionEditorData().getExpression());
				}
		});
		new Label(composite, SWT.NONE);
		new Label(composite, SWT.NONE);
								...
								browseButton.addSelectionListener(new SelectionAdapter() {
									...
									public void widgetSelected(SelectionEvent e) {
										...
										launchExpressionEditor.launchExpressionEditor(mappingSheetRow.getMergeExpressionDataForGroupCombine(),
												getInputSchema(component), mappingSheetRow.getOperationID());
										expressionTextBox.setText(mappingSheetRow.getMergeExpressionDataForGroupCombine().getExpression());
									}
		...
		Label mergeExpressionNewLabel = new Label(composite, SWT.NONE);
		GridData gd_lblNewLabel = new GridData(SWT.LEFT, SWT.CENTER, true, false, 1, 1);
		gd_lblNewLabel.minimumWidth = 50;
		mergeExpressionNewLabel.setLayoutData(gd_lblNewLabel);
		mergeExpressionNewLabel.setText(Messages.MERGE_EXPRESSION);

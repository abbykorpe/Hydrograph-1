...
import hydrograph.ui.propertywindow.widgets.customwidgets.sql.QueryDialog;
...
public class QueryWidget extends AbstractWidget {
	...
	public void attachToPropertySubGroup(AbstractELTContainerWidget subGroup) {
		...
		AbstractELTWidget eltDefaultLable = new ELTDefaultLable("Query");
		...
		((Button) eltDefaultButton.getSWTWidgetControl()).addSelectionListener(new SelectionAdapter() {
			...
			QueryDialog queryDialog = new QueryDialog(((Button) eltDefaultButton
					.getSWTWidgetControl()).getShell(), propertyDialogButtonBar, (QueryProperty) properties);

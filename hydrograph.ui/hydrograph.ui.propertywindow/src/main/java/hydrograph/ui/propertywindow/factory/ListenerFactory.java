...
import hydrograph.ui.propertywindow.widgets.listeners.VerifyTwoDigitNumericListener;
...
public class ListenerFactory {
	...
	public enum Listners{
		...
		VERIFY_TWO_DIGIT_NUMERIC_LISTENER(VerifyTwoDigitNumericListener.class),

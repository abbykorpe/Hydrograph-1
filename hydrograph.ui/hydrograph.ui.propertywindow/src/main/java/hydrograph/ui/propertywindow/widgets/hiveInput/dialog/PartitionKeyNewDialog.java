...
public class PartitionKeyNewDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		lowerComposite = new Composite(sashForm, SWT.BORDER);
		lowerComposite.setLayout(new GridLayout(1, false));
		
		Composite lowerButtoncomposite = new Composite(lowerComposite, SWT.NONE);
		GridData gd_lowerButtoncomposite = new GridData(SWT.FILL, SWT.TOP, true, false, 1, 1);
		...
		btnNewButton_1.setBounds(245, 0, 60, 25);
		...
		btnNewButton_2.setBounds(168, 0, 71, 25);
		btnNewButton_2.setText("Delete Row");
		
		createLowerTable(lowerComposite);
		
		lowerComposite.setVisible(false);
		sashForm.setWeights(new int[] {380, 328});

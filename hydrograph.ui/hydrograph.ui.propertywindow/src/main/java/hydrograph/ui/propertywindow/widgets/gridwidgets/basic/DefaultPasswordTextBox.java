 ...
 * 
 */
public class DefaultPasswordTextBox extends AbstractELTWidget{
	 ...
	 */
	public DefaultPasswordTextBox(){}
		
	@Override
	public void attachWidget(Composite container) {
		defaultELTTextBox = new Text(container, SWT.BORDER | SWT.PASSWORD);
	 ...
	 */
	public DefaultPasswordTextBox textBoxWidth(int textboxWidth){
	 ...
	 * @return the ELT default text box
	 */
	public DefaultPasswordTextBox defaultText(String defaultTextMessage){
	 ...
	 * @return the ELT default text box
	 */
	public DefaultPasswordTextBox grabExcessHorizontalSpace(boolean grabExcessSpace){
	 ...
	 * @return the ELT default text box
	 */
	public DefaultPasswordTextBox visibility(boolean visible){ 
	 ...
	 * @return the ELT default text box
	 */
	public DefaultPasswordTextBox setEnabled(boolean enabled){ 

 ...
 *
 */
public class OutputSparkRedshiftConverter extends OutputConverter {
	
	private static final Logger logger = LogFactory.INSTANCE.getLogger(OutputSparkRedshiftConverter.class);

	public OutputSparkRedshiftConverter(Component component) {
		super(component);
	...
	public void prepareForXML() {
		...
		super.prepareForXML();
		Sparkredshift redshiftOutput = (Sparkredshift) baseComponent;
		...
		setTemporaryDirectoryName(redshiftOutput);

 ...
 *       &lt;sequence>
 *         &lt;element name="outSocket" type="{hydrograph/engine/jaxb/ifsubgraph}type-input-delimited-out-socket" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "type-input-file-delimited-base", namespace = "hydrograph/engine/jaxb/ifsubgraph")
@XmlSeeAlso({
    Subgraph.class
})

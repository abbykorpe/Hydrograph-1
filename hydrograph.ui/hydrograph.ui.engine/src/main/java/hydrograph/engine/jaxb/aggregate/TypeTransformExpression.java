 ...
 *       &lt;sequence>
 *         &lt;element name="inputFields" type="{hydrograph/engine/jaxb/aggregate}type-operation-input-fields" minOccurs="0"/>
...
@XmlType(name = "type-transform-expression", namespace = "hydrograph/engine/jaxb/aggregate")

 ...
 *           &lt;element name="passThroughField" type="{hydrograph/engine/jaxb/groupcombine}type-operation-input-field"/>
...
@XmlType(name = "type-out-socket", namespace = "hydrograph/engine/jaxb/groupcombine")

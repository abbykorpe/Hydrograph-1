 ...
 *
 */
public class JDBCDriverClassWidgetDatastructureValidation implements IValidator{
	...
	public boolean validate(Object object, String propertyName, Map<String, List<FixedWidthGridRow>> inputSchemaMap,
		...
		if (object != null) {
			JDBCDriverClassWidgetDatastructure jdbcDriverClassWidgetDatastructure = (JDBCDriverClassWidgetDatastructure) object;
			if (jdbcDriverClassWidgetDatastructure != null) {
				if(StringUtils.isNotBlank(jdbcDriverClassWidgetDatastructure.getDataBaseValue()) &&
						StringUtils.isNotBlank(jdbcDriverClassWidgetDatastructure.getJdbcDriverClassValue()) ){
					return true;
				}
			}
		}

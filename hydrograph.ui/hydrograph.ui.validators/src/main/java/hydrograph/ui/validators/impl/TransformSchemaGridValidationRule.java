...
/**
 * Schema Grid validation without checking the length parameter.
 * This validation rule is appplied on components like Join, Lookup etc. where 
 * input to these components can be either from fixed width component or delimited component.
 * 
 * @author BITWISE
 */

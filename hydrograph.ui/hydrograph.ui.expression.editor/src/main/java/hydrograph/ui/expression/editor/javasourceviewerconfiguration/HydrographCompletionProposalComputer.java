...
public class HydrographCompletionProposalComputer implements IJavaCompletionProposalComputer   {
	...
	public List<ICompletionProposal> computeCompletionProposals(
	 ...
	 public List<ICompletionProposal> computeCompletionProposals(ITextViewer textViewer, String prefix, int offset, IProgressMonitor monitor) {
	       ...
	       for(ClassDetails classDetails:classList)
	        ...
	        {
	        	displayLabel=classDetails.getcName()+"."+methodDetails.getSignature();
	        	...
	        	HydrographCompletionProposal customProposal=new HydrographCompletionProposal(replacementString,offset-prefix.length(),replacementLength,replacementString.length(),
	        			new Image(null,XMLConfigUtil.CONFIG_FILES_PATH +"/icons/16x16_8bit.bmp"),displayLabel,null,null);
	...
	public List<IContextInformation> computeContextInformation(
			ContentAssistInvocationContext paramContentAssistInvocationContext,

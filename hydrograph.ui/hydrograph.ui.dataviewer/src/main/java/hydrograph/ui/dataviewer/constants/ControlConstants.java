...
public class ControlConstants {
	...
	public static String PREVIOUS_BUTTON_DISPLAY_TEXT="Previous";
	public static String NEXT_BUTTON_DISPLAY_TEXT="Next";
	public static String JUMP_BUTTON_DISPLAY_TEXT="Go";	
	public static String JUMP_TO_PAGE_LABEL_TEXT="Jump to Page: ";	

 ...
 * @author Bitwise
 */
public class SubGraphPropertiesWidget extends AbstractWidget {
	private static final Logger logger = LogFactory.INSTANCE.getLogger(SubGraphPropertiesWidget.class);
	 ...
	 */
	public SubGraphPropertiesWidget(ComponentConfigrationProperty componentConfigProp,
	...
	public void attachToPropertySubGroup(AbstractELTContainerWidget container) {
		...
		ELTDefaultLable defaultLable1 = new ELTDefaultLable("SubGraph\nProperties"); 

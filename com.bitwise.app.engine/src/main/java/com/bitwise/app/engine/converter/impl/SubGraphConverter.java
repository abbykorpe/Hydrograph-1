...
public class SubGraphConverter extends TransformConverter {
	...
	private static final Logger logger = LogFactory.INSTANCE.getLogger(SubGraphConverter.class);
	private ConverterHelper converterHelper;
	private JoinMappingGrid joinupPropertyGrid;

	public SubGraphConverter(Component component) {
		super();

...
public class AggregateUDAFForExpression implements AggregatorTransformBase{
	...
	public AggregateUDAFForExpression() {
	}
	...
	public void update(ReusableRow bufferRow, ReusableRow inputRow) {
		Object tuples[] = new Object[inputRow.getFieldNames().size() + 1];
		int i = 0;

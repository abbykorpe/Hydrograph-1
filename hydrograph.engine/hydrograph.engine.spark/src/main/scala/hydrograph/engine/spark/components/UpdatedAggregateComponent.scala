...
/**
  ...
  */
class UpdatedAggregateComponent(aggregateEntity: AggregateEntity, componentsParams: BaseComponentParams) extends
  ...
  override def createComponent(): Map[String, DataFrame] = {
    ...
    val intermediateDf = sortedDf.mapPartitions(itr => {
      ...
      val aggregateList: List[SparkOperation[AggregateTransformBase]] = initializeTransformList(aggregateEntity.getOperationsList,
        inputSchema,
        outputSchema)

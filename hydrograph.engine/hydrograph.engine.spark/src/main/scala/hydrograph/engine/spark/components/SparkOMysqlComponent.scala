...
BaseComponentParams) extends SparkFlow {
  ...
  override def execute(): Unit = {
    ...
    LOG.info("connection url for Mysql output component: " + connectionURL)
    LOG.info("Data load option '" + outputRDBMSEntity.getLoadType + "'  for Mysql output component ")
  ...
  def executeQuery(connectionURL: String, properties: java.util.Properties, query: String): Unit = {
    ...
    LOG.info("executing '" + query + "' for Mysql output component")

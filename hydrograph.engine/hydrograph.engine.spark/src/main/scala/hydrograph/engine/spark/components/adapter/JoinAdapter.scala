...
import hydrograph.engine.spark.components.{SparkJoinComponent, SparkTransformComponent}
...
var sparkJoinComponent:SparkJoinComponent=null;
  ...
  override def createComponent(baseComponentParams: BaseComponentParams): Unit = {
    sparkJoinComponent= new SparkJoinComponent(joinEntity.getEntity,baseComponentParams)
  }

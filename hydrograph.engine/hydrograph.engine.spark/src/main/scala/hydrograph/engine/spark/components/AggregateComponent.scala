 ...
 */
class AggregateComponent(aggregateEntity: AggregateEntity, componentsParams: BaseComponentParams) extends OperationComponentBase with AggregateOperation with Serializable {

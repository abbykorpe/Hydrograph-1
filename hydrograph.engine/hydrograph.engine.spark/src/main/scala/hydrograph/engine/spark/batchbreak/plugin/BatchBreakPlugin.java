...
import hydrograph.engine.spark.flow.utils.FlowManipulationContext;
import hydrograph.engine.spark.flow.utils.ManipulatorListener;
...
public class BatchBreakPlugin implements ManipulatorListener {
	...
	private String getTempPath(String prefix, Configuration jobConf) {
		...
		String tempPath = (new org.apache.hadoop.fs.Path(jobConf.get("hadoop.tmp.dir"), name)).toString();

...
public class Count implements AggregateTransformBase,Serializable {
	...
	public void prepare(Properties props, ArrayList<String> inputFields, ArrayList<String> outputFields, ArrayList<String> keyFields) {

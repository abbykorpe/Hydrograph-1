...
/**
  ...
  */
class OutputFileDelimitedComponentTest {
  ...
  def itShouldCheckFirstRecordInOutputFileIsHeaderWhenHasHeaderIsTrue() : Unit = {
    ...
    //when
    val comp = new OutputFileDelimitedComponent(outputFileDelimitedEntity, baseComponentParams)
    comp.execute()
  ...
  def itShouldWriteFewColumnProvidedInEntity() : Unit = {
    ...
    //when
    val comp = new OutputFileDelimitedComponent(outputFileDelimitedEntity1, baseComponentParams)
    comp.execute()
  ...
  def itShouldWriteQuoteCharacterInOutputFile() : Unit = {
    ...
    //when
    val comp = new OutputFileDelimitedComponent(outputFileDelimitedEntity2, baseComponentParams1)
    comp.execute()

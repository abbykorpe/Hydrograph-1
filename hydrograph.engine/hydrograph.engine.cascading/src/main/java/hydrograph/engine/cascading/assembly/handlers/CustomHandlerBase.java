...
public interface CustomHandlerBase extends Serializable {
	...
	public Object onPrepare(OperationCall<CustomFunctionContext> call);

	public void perform(FunctionCall<CustomFunctionContext> call);

	public void onCleanup(FunctionCall<CustomFunctionContext> call);

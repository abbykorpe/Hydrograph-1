...
public class FilterAdapter extends OperationAdapterBase {

	
	private static final long serialVersionUID = -7278948054863697381L;
	FilterAssembly filterAssembly;
	FilterEntityGenerator filterGenerator;

	public FilterAdapter(TypeBaseComponent baseComponent) {

		filterGenerator = new FilterEntityGenerator(baseComponent);
	}

	@Override
	public void createAssembly(ComponentParameters componentParameters) {
		filterAssembly = new FilterAssembly(filterGenerator.getEntity(), componentParameters);

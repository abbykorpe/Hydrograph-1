...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: hydrograph.engine.jaxb.igr
     * 
     */
     ...
     * 
     */
    public TypeGenerateRecordRecord createTypeGenerateRecordRecord() {
        return new TypeGenerateRecordRecord();
    }

...
/**
 * <p>Java class for type-output-xml-in-socket complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="type-output-xml-in-socket">
 *   &lt;complexContent>
 *     &lt;restriction base="{hydrograph/engine/jaxb/commontypes}type-output-inSocket">
 *       &lt;sequence>
 *         &lt;element name="schema" type="{hydrograph/engine/jaxb/ofxml}type-xml-record"/>
 *       &lt;/sequence>
...
@XmlType(name = "type-output-xml-in-socket", namespace = "hydrograph/engine/jaxb/ofxml")
public class TypeOutputXmlInSocket

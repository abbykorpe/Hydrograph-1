...
public class XmlUtilitiesTest {
	...
	public void getXmlDocumentTest() {
		String xmlContent = XmlParsingUtils.getXMLStringFromPath("testData/XMLFiles/schema.xml");
		Document xmlDocument = XmlUtilities.getXMLDocument(xmlContent);
		System.out.println(xmlDocument.getFirstChild().getNodeName());
	}
}

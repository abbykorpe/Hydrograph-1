...
public class StringLengthTest {
	...
	public void testCalculateStringLength() {
		...
		Assert.assertEquals("not matched", new Integer(7), stringLength(input));
	}

	@Test
	public void testCalculateLengthOfDouble() {
		Double input = new Double(12345.05);
		Assert.assertEquals("not matched", new Integer(8), stringLength(input));
	}

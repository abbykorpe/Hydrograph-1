...
public class StringUpperTest {
	...
	@Test
	public void testUpperOnNull() {
		String input = null;
		Assert.assertEquals("not matched", null, stringUpper(input));
	}
	
	@Test
	public void testUpperOnString() {
		String input = "bitwise";
		Assert.assertEquals("not matched", "BITWISE", stringUpper(input));
	}

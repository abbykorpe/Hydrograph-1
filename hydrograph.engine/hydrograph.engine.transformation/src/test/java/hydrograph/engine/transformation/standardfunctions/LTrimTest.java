...
public class LTrimTest {
	...
	public void testTrimOnNull() {
		String input = null;
		Assert.assertEquals("not matched", null, stringLeftTrim(input));
	}
	
	@Test
	public void testTrimOnString() {
		String input = "   bitwise   ";
		Assert.assertEquals("not matched", "bitwise   ", stringLeftTrim(input));
	}

	@Test
	public void testTrimOnInteger() {
		int input = 10;
		Assert.assertEquals("not matched", new Integer(10), stringLeftTrim(input));
	}
